...
latin_lc = set([species[0] for species in birds]) #takes the first element [0] from each of the tuples (species) within the tuple "birds"
print(latin_lc) #returns a set

# Create list of common names of each species in birds
latin_lc = set([species[1] for species in birds])
print(latin_lc)


# Create list of mean body masses of each species in birds
latin_lc = set([species[2] for species in birds])
print(latin_lc)

#(2) For loops

# For loop of latin names of each species in birds
latin_loops = set() # initialise set
for species in birds:
    latin_loops.add(species[0]) #Takes the first element and appends it to the set "latin loops"
print(latin_loops)

# For loop of common names of each species in birds
latin_loops = set()
for species in birds:
    latin_loops.add(species[1])
print(latin_loops)

# For loop of the mean body mass for each species in birds
latin_loops = set()
for species in birds:
    latin_loops.add(species[2])
print(latin_loops)
